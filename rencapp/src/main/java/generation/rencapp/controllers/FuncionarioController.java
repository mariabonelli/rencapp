...
import generation.rencapp.services.FuncionarioService;
import generation.rencapp.services.FuncionarioServiceImp;
...
@RequestMapping("api/funcionario")
    ...
    @Autowired
    private FuncionarioServiceImp funcionarioServiceImpl;
    ...
    @DeleteMapping("/{id}")
    public void delete funcionario(@PathVariable Long id){
